...
# Define the pipeline function that will be called when the button is clicked
def run_pipeline_handler(subreddits, min_length, voice_speed, voice_selection, video_quality, cinematic_ratio, use_dust_overlay, progress=None):
    """Handler function that imports pipeline modules only when called"""
    # Import pipeline functions only when needed
